							...
							<div class="row">
								...
								<div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-header">
											<a href="{{route('chitietsanpham',$km->id)}}"><img src="source/image/product/{{$km->image}}" alt="" height="250px" width="300px"></a>
										</div>
										<div class="single-item-body">
											...
											<p class="single-item-price">
												...
												@else
												<span class="flash-del">{{$km->unit_price}}đ</span>
												<span class="flash-sale">{{$km->promotion_price}}đ</span>
												@endif
											</p>
										</div>
										<div class="single-item-caption">
