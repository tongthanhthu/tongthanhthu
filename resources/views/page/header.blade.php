...
<div id="header">
			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i>xóm 11 xã Hải Phúc - Hải Hậu - Nam Định</a></li>
						<li><a href=""><i class="fa fa-phone"></i> 0 941 507 816</a></li>
					</ul>
				</div>
								...
								<div class="cart-item">
									...
									<div class="media">
										...
										@if($product['item']['promotion_price']==0)
											{{$product['item']['unit_price']}}đ 
										@else
										    {{$product['item']['promotion_price']}}đ
										 @endif
									</span></span>
										</div>
									</div>
		...
		<div class="header-bottom" style="background-color: #0277b8;">
			<div class="container">
				<a class="visible-xs beta-menu-toggle pull-right" ><span class='beta-menu-toggle-text'>Menu</span> <i class="fa fa-bars"></i></a>
	...
	<!-- 	href="{{route('loaisanpham',$loai->id)}}" -->